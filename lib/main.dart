                  ...
                  child: AtomBuilder(
                    builder: (context) => Column(
                      ...
                      children: [
                        ...
                        spacing,
                        spacing,
                        Text('MaybeTrackAge: ${context.get(maybeTrackAge)}'),
                        spacing,
                        TextButton(
                          onPressed: () => context.mutate(shouldTrackAge, (value) => !value),
                          child: Text('should track age? ${context.get(shouldTrackAge)}'),
                        ),
                      ],
                    ),
                  ),
                    ...
                    if (_showSelectors) ...[
                      ...
                      AtomBuilder(
                        builder: (context) {
                          ...
                          return Text(
                            'PersonState (id): ${context.get(personState.select((_) => _.id))}',
                          );
                        },
                      ),
                      spacing,
                      AtomBuilder(
                        builder: (context) {
                          ...
                          return Text(
                            'PersonState (canDrive): ${context.get(personState.select((_) => _.canDrive))}',
                          );
                        },
                      ),
                      spacing,
                      AtomBuilder(
                        builder: (context) {
                          ...
                          return Text(
                            'PersonState (fullname): ${context.get(personState.select((_) => _.fullname))}',
                          );
                        },
                      ),
                    ],
